<nav class="navbar navbar-expand-xl navbar-light text-center py-3  fixed-top bg-white">
    <div class="container">
        <a class="navbar-brand" href="index.html">
            <img loading="prelaod" decoding="async" class="img-fluid" width="160" src="/assets/images/logo.png" alt="Wallet">
        </a>
